...
The `MATLAB-Visualisation/` folder contains MATLAB Live Scripts for data analysis:

| Script | Description |
|--------|-------------|
| `main_results_sardine_run.mlx` | Primary results analysis and visualisation |
| `preliminary_results_sardine_run.mlx` | Initial exploratory analysis |
| `sensitivity_plots.mlx` | Parameter sensitivity analysis plots |

These scripts read the benchmark CSV files (`benchmark_results_*.csv`, `cohesion_timeseries_*.csv`) generated by the Python simulation to produce comparative plots across different predator counts (3, 5, 7, 9).
